...
def yieldout(year):
	...
	maitrop1 = region1.variables['fmai_rf'][bb1,:,:]
        maitropi1=region1.variables['fmai_irr'][bb1,:,:]
	...
	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_irr_fert/output/mai_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_mai_luh2.nc','w',format='NETCDF3_64BIT_OFFSET')
