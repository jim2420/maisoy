...
def yieldout(year):
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_fert/output/mai_fert.nc','r')
        clmtropf = isam.variables['totalyield'][bb,:,:]

	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_irr_fert/output/mai_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_mai_mircarcp85new.nc','w',format='NETCDF3_64BIT_OFFSET')
