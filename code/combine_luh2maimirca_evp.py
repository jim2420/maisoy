...
def yieldout(year):
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_fert/output/mai_fert_evp.nc','r')
        clmtropf = isam.variables['g_ET'][bb-1,0,:,:]

	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_irr_fert/output/mai_irr_fert_evp.nc','r')
	clmtropfi = clm2.variables['g_ET'][bb-1,0,:,:]
...
ncfile=NetCDFFile('isamhiscru_mai_mirca_evp.nc','w',format='NETCDF3_64BIT_OFFSET')
