...
def yieldout(year):
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/vmax1/soy_fert/output/soy_fert_bnf.nc','r')
        clmtropf = isam.variables['annual_nfix'][bb-1,25,:,:]

	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/vmax1/soy_irr_fert/output/soy_irr_fert_bnf.nc','r')
	clmtropfi = clm2.variables['annual_nfix'][bb-1,25,:,:]
	...
	clmall=((yield_clmtf*maizetor*10000)+(yield_clmtfi*maizetoi*10000))
...
ncfile=NetCDFFile('isamhiscru_soy_luh2bnf.nc','w',format='NETCDF3_64BIT_OFFSET')
...
maize1.units = 'm2'
maize2.units = 'kgN'
maize3.units = 'kgN/ha over gridareas'
