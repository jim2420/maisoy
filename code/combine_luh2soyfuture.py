...
def yieldout(year):
        bb=year-2015
	bb1=year-2015
	region1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_rcp45_corrcrop.nc','r')
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_fert/output/soy_fert.nc','r')
        clmtropf = isam.variables['totalyield'][bb,:,:]

	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_irr_fert/output/soy_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_soy_luh2rcp45new.nc','w',format='NETCDF3_64BIT_OFFSET')
