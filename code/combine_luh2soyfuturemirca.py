...
def yieldout(year):
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/soy_fert/output/soy_fert.nc','r')
        clmtropf = isam.variables['totalyield'][bb,:,:]

	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/soy_irr_fert/output/soy_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_soy_mircarcp85new.nc','w',format='NETCDF3_64BIT_OFFSET')
