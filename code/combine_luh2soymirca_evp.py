...
def yieldout(year):
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/new/soy_fert/output/soy_fert.nc','r')
        clmtropf = isam.variables['g_ET'][bb-1,1,:,:]

        clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/new/soy_irr_fert/output/soy_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_soy_mirca_evp.nc','w',format='NETCDF3_64BIT_OFFSET')
