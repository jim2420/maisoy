...
def yieldout(year):
	...
	maizeto = maitrop+maitropi
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/vmax2/soy_fert/output/soy_fert.nc','r')
        clmtropf = isam.variables['totalyield'][bb-1,:,:]

	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/vmax2/soy_irr_fert/output/soy_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_soy_luh2vmax2.nc','w',format='NETCDF3_64BIT_OFFSET')
