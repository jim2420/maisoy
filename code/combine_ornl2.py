...
isam=NetCDFFile('../../rice_cheyenne/isamhiscru_rice_eguornl_m3.nc','r')
...
maize1= ncfile.createVariable('yieldm3', 'f8', ('lat','lon'),fill_value=-9999.)
