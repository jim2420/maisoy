...
def region(x,ryield):
	...
	meareaisam= ma.masked_where(meareaisam<=0.0,meareaisam)
        ...
        isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_850_2015_corrcrop.nc','r')
        meareaisam1 = isam1.variables['fmai_tt'][1051,:,:]#1901
...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium/output/maiequilibrium_evp.nc','r')
eiyield1ynew = edat.variables['g_ET'][0:115,0,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/equili/maiequilibrium_irr/output/maiequilibrium_irr_evp.nc','r')
eiyield2ynew = edat2.variables['g_ET'][0:115,0,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_fert/output/maiequilibrium_fert_evp.nc','r')
eiyield3ynew = edat3.variables['g_ET'][0:115,0,:,:]
edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_co2/output/maiequilibrium_co2_evp.nc','r')
eiyield4ynew = edat4.variables['g_ET'][0:115,0,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_cli/output/maiequilibrium_cli_evp.nc','r')
eiyield5ynew = edat5.variables['g_ET'][0:115,0,:,:]

dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_irr_fert/output/mai_irr_fert_evp.nc','r')
iyield1ynew = dat.variables['g_ET'][0:115,0,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]

dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_fert/output/mai_fert_evp.nc','r')
iyield2ynew = dat2.variables['g_ET'][0:115,0,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_irr/output/mai_irr_evp.nc','r')
iyield3ynew = dat3.variables['g_ET'][0:115,0,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_co2/output/mai_co2_evp.nc','r')
iyield4ynew = dat4.variables['g_ET'][0:115,0,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_cli/output/mai_cli_evp.nc','r')
...
ncfile=NetCDFFile('mai1901_2015region_evp.nc','w',format='NETCDF3_64BIT_OFFSET')
