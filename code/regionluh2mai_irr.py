...
edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/equili/maiequilibrium_irr/output/maiequilibrium_irr_irr.nc','r')
...
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_irr/output/mai_irr_irr.nc','r')
iyield3ynew = dat3.variables['irrigation'][0:115,0,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_co2/output/mai_co2_irr.nc','r')
iyield4ynew = dat4.variables['irrigation'][0:115,0,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_cli/output/mai_cli_irr.nc','r')
...
ncfile=NetCDFFile('mai1901_2015region_irr.nc','w',format='NETCDF3_64BIT_OFFSET')
