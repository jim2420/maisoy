...
def region(x,ryield):
	...
	meareaisam = isam1.variables['fmai_tt'][:,:,:]
	meareaisam= ma.masked_where(meareaisam<=0.0,meareaisam)

        isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_rcp85_corrcrop.nc','r')
        meareaisam1 = isam1.variables['fmai_tt'][0,:,:]#1901
...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2NFrate_rcp85_cropfinal.nc','r')
iyield1ynew = dat.variables['mainf'][:,:,:]
...
ncfile=NetCDFFile('mairegionNFrcp85.nc','w',format='NETCDF3_64BIT_OFFSET')
