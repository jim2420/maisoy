...
nn=9
year=115
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium/output/soyequilibrium_evp.nc','r')
eiyield1ynew = edat.variables['g_ET'][0:115,1,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/equili/soyequilibrium_irr/output/soyequilibrium_irr_evp.nc','r')
eiyield2ynew = edat2.variables['g_ET'][0:115,1,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_fert/output/soyequilibrium_fert_evp.nc','r')
eiyield3ynew = edat3.variables['g_ET'][0:115,1,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_co2/output/soyequilibrium_co2_evp.nc','r')
eiyield4ynew = edat4.variables['g_ET'][0:115,1,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_cli/output/soyequilibrium_cli_evp.nc','r')
eiyield5ynew = edat5.variables['g_ET'][0:115,1,:,:]



dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_irr_fert/output/soy_irr_fert_evp.nc','r')
iyield1ynew = dat.variables['g_ET'][0:115,1,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_fert/output/soy_fert_evp.nc','r')
iyield2ynew = dat2.variables['g_ET'][0:115,1,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_irr/output/soy_irr_evp.nc','r')
iyield3ynew = dat3.variables['g_ET'][0:115,1,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_co2/output/soy_co2_evp.nc','r')
iyield4ynew = dat4.variables['g_ET'][0:115,1,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_cli/output/soy_cli_evp.nc','r')
iyield5ynew = dat5.variables['g_ET'][0:115,1,:,:]
...
ncfile=NetCDFFile('soy1901_2015region_evp.nc','w',format='NETCDF3_64BIT_OFFSET')
