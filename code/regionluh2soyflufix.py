...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium/output/soyequilibrium.nc','r')
eiyield1ynew = edat.variables['totalyield'][:,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
eiyield2ynew = edat2.variables['totalyield'][:,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_fert/output/soyequilibrium_fert.nc','r')
eiyield3ynew = edat3.variables['totalyield'][:,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_co2/output/soyequilibrium_co2.nc','r')
eiyield4ynew = edat4.variables['totalyield'][:,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_cli/output/soyequilibrium_cli.nc','r')
eiyield5ynew = edat5.variables['totalyield'][:,:,:]

dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_irr_fert/output/soy_irr_fert.nc','r')
iyield1ynew = dat.variables['totalyield'][:,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_fert/output/soy_fert.nc','r')
iyield2ynew = dat2.variables['totalyield'][:,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/soy_irr/output/soy_irr.nc','r')
iyield3ynew = dat3.variables['totalyield'][:,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/soy_co2/output/soy_co2.nc','r')
iyield4ynew = dat4.variables['totalyield'][:,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/soy_cli/output/soy_cli.nc','r')
...
ncfile=NetCDFFile('soyregion_rcp85fixedlu.nc','w',format='NETCDF3_64BIT_OFFSET')
