...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/maiequilibrium/output/maiequilibrium.nc','r')
eiyield1ynew = edat.variables['totalyield'][:,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/maiequilibrium_irr/output/maiequilibrium_irr.nc','r')
eiyield2ynew = edat2.variables['totalyield'][:,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/maiequilibrium_fert/output/maiequilibrium_fert.nc','r')
eiyield3ynew = edat3.variables['totalyield'][:,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/maiequilibrium_co2/output/maiequilibrium_co2.nc','r')
eiyield4ynew = edat4.variables['totalyield'][:,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/maiequilibrium_cli/output/maiequilibrium_cli.nc','r')
eiyield5ynew = edat5.variables['totalyield'][:,:,:]

dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/mai_irr_fert/output/mai_irr_fert.nc','r')
iyield1ynew = dat.variables['totalyield'][:,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/mai_fert/output/mai_fert.nc','r')
iyield2ynew = dat2.variables['totalyield'][:,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/mai_irr/output/mai_irr.nc','r')
iyield3ynew = dat3.variables['totalyield'][:,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/mai_co2/output/mai_co2.nc','r')
iyield4ynew = dat4.variables['totalyield'][:,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/mai_cli/output/mai_cli.nc','r')
iyield5ynew = dat5.variables['totalyield'][:,:,:]


iyield6ynew=N.zeros((86,360,720))
dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_mai_mircarcp45new.nc','r')
...
ncfile=NetCDFFile('mairegion_rcp45newmirca.nc','w',format='NETCDF3_64BIT_OFFSET')
