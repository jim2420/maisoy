...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/equili/maiequilibrium/output/maiequilibrium.nc','r')
eiyield1ynew = edat.variables['g_ET'][:,0,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/equili/maiequilibrium_irr/output/maiequilibrium_irr.nc','r')
eiyield2ynew = edat2.variables['g_ET'][:,0,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/equili/maiequilibrium_fert/output/maiequilibrium_fert.nc','r')
eiyield3ynew = edat3.variables['g_ET'][:,0,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/equili/maiequilibrium_co2/output/maiequilibrium_co2.nc','r')
eiyield4ynew = edat4.variables['g_ET'][:,0,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/equili/maiequilibrium_cli/output/maiequilibrium_cli.nc','r')
eiyield5ynew = edat5.variables['g_ET'][:,0,:,:]

dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_irr_fert/output/mai_irr_fert.nc','r')
iyield1ynew = dat.variables['g_ET'][:,0,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_fert/output/mai_fert.nc','r')
iyield2ynew = dat2.variables['g_ET'][:,0,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_irr/output/mai_irr.nc','r')
iyield3ynew = dat3.variables['g_ET'][:,0,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_co2/output/mai_co2.nc','r')
iyield4ynew = dat4.variables['g_ET'][:,0,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85new/mai_cli/output/mai_cli.nc','r')
iyield5ynew = dat5.variables['g_ET'][:,0,:,:]


iyield6ynew=N.zeros((86,360,720))
dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_mai_mircarcp85new_evp.nc','r')
...
ncfile=NetCDFFile('mairegion_rcp85newmirca_evp.nc','w',format='NETCDF3_64BIT_OFFSET')
