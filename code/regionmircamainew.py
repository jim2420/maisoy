...
dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_mai_mirca.nc','r')
...
ncfile=NetCDFFile('mai1901_2015regionnewmirca.nc','w',format='NETCDF3_64BIT_OFFSET')
