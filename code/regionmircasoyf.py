...
dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_soy_mircarcp45new.nc','r')
...
ncfile=NetCDFFile('soyregion_rcp45newmirca.nc','w',format='NETCDF3_64BIT_OFFSET')
