...
def region(x,ryield):
	...
	isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_rcp45_corrcrop.nc','r')
	...
	meareaisam= ma.masked_where(meareaisam<=0.0,meareaisam)
        ...
        meareaisam1 = isam1.variables['asoy_tt'][:,:]#mirca2000
...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/soyequilibrium/output/soyequilibrium.nc','r')
eiyield1ynew = edat.variables['g_ET'][:,1,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
eiyield2ynew = edat2.variables['g_ET'][:,1,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/soyequilibrium_fert/output/soyequilibrium_fert.nc','r')
eiyield3ynew = edat3.variables['g_ET'][:,1,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/soyequilibrium_co2/output/soyequilibrium_co2.nc','r')
eiyield4ynew = edat4.variables['g_ET'][:,1,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/equili/soyequilibrium_cli/output/soyequilibrium_cli.nc','r')
eiyield5ynew = edat5.variables['g_ET'][:,1,:,:]

dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_irr_fert/output/soy_irr_fert.nc','r')
iyield1ynew = dat.variables['g_ET'][:,1,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_fert/output/soy_fert.nc','r')
iyield2ynew = dat2.variables['g_ET'][:,1,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_irr/output/soy_irr.nc','r')
iyield3ynew = dat3.variables['g_ET'][:,1,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_co2/output/soy_co2.nc','r')
iyield4ynew = dat4.variables['g_ET'][:,1,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45new/soy_cli/output/soy_cli.nc','r')
iyield5ynew = dat5.variables['g_ET'][:,1,:,:]

iyield6ynew=N.zeros((86,360,720))
dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_soy_mircarcp45new_evp.nc','r')
...
ncfile=NetCDFFile('soyregion_rcp45newmirca_evp.nc','w',format='NETCDF3_64BIT_OFFSET')
