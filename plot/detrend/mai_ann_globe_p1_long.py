...
faop=N.zeros(x)
#global
faoy1=[19423,19796,20311,19937,21237,22078,24236,22894,24206,23509,26534,26867,27217,25565,28132,28371,29668,31556,33847,31534,34933,36090,29452,35256,37202,36279,34863,31001,36186,36907,36996,39064,36305,41120,38100,42061,41511,44354,44255,43236,44775,43884,44610,49452,48196,47719,49980,50828,51635,51903,51751,48893,54611,56229,55379]
#us
...
#	plt.title("Anormaly by subtracting a moving mean average",fontsize=18)
	...
	plt.savefig('maize_faoclm_{0}_paper1_long.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
