...
faoy=N.zeros(x)
faop=N.zeros(x)
faoy1=[39184,40621,42596,39498,46492,45892,50265,49891,53908,45439,55270,60897,57278,45119,54213,55206,57015,63421,68734,57118,68380,71082,50893,66981,74074,74930,75225,53109,72978,74380,68171,82526,63210,86996,71228,79773,79521,84382,83977,85911,86733,81180,89246,100637,92852,93577,94585,96209,103181,95757,92146,77270,99256,107326,105723]
#us
...
#	plt.title("Anormaly by subtracting a moving mean average",fontsize=18)
	...
	plt.savefig('mai_fao_{0}_paper1.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
