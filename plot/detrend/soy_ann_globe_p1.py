...
def annualyield(year,couna,counb):
    ...
    clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_soy_luh2.nc','r')
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('soy_faoclm_{0}_paper1.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
