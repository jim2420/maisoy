...
faoy=N.zeros(x)
faop=N.zeros(x)
faoy1=[16900,16302,16432,15309,16508,17087,16498,17986,18435,17941,18522,18706,18696,15933,19421,17543,20552,19741,21614,17827,20331,21213,17594,18930,22923,22411,22794,18155,21783,22920,23029,25295,21941,27813,23759,25269,26164,26169,24634,25614,26639,25567,22769,28405,28961,28817,28067,26718,29595,29243,28232,26867,29615,31977,32289]
#us
...
#	plt.title("Anormaly by subtracting a moving mean average",fontsize=18)
	...
	plt.savefig('soy_fao_{0}_paper1.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
