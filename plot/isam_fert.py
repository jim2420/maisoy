...
ma1y = region.variables['totalyield'][95:105,:,:]#1996-2005
...
ma2y = region1.variables['totalyield'][95:105,:,:]

region=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2NFrate_1901_2015_cropfinal.nc','r')

ma1 = region.variables['mainf'][95:105,:,:]#1996-2005
ma1= ma.masked_where(ma1<=0.0,ma1)

region1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2NFrate_1901_2015_cropfinal.nc','r')

ma2 = region1.variables['soynf'][95:105,:,:]
ma2= ma.masked_where(ma2<=0.0,ma2)


ma1y= ma.masked_where(ma1y<=0.0,ma1y)
ma2y= ma.masked_where(ma2y<=0.0,ma2y)
...
ma1y=N.ma.average(ma1y,axis=0)
ma2y=N.ma.average(ma2y,axis=0)
...
ma1y,lona11=shiftgrid(180.5,ma1y,lonisam1,start=False)
ma2y,lona11=shiftgrid(180.5,ma2y,lonisam1,start=False)

ma1= ma.masked_where(ma1y<=0.0,ma1)
ma2= ma.masked_where(ma2y<=0.0,ma2)
...
plt.savefig('isam_fert1996_2005_kgNha.jpg',bbox_inches='tight')
