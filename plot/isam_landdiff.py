...
meareaisam = isam1.variables['fmai_tt'][1146:1156,:,:]#1996-2005
...
#ma1i=ma1i
isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_850_2015_corrcrop.nc','r')
meareaisam1 = isam1.variables['fsoy_tt'][1146:1156,:,:]
...
ma1i=N.ma.average(ma1i,axis=0)
ma2i=N.ma.average(ma2i,axis=0)
...
ma1= ma.masked_where(ma1i<=0.0,ma1)
ma2= ma.masked_where(ma2i<=0.0,ma2)
ma1i= ma.masked_where(ma1<=0.0,ma1i)
ma2i= ma.masked_where(ma2<=0.0,ma2i)
ma1= ma.masked_where(ma1i<=0.0,ma1)
ma2= ma.masked_where(ma2i<=0.0,ma2)
...
plt.savefig('isamland85_2090.jpg',bbox_inches='tight')
