...
meareaisam = isam1.variables['fmai_tt'][1150,:,:]#1996-2005
...
#ma1i=ma1i
isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_850_2015_corrcrop.nc','r')
meareaisam1 = isam1.variables['fsoy_tt'][1150,:,:]
...
cmap = plt.cm.jet
bounds=[2.5,5,7.5,10,12.5,15,17.5,20]
...
aa=ma1/1000
aa= ma.masked_where(aa<=0.5,aa)

map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,aa,cmap=cmap,vmin=0.5,vmax=25)
...
plt.savefig('isamland_2000.jpg',bbox_inches='tight')
