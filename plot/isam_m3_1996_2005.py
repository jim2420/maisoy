...
region=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_mai_luh2rcp45.nc','r')
ma1h = region.variables['yield'][75:85,:,:]
...
plt.savefig('isam_maisoy19962005.jpg',bbox_inches='tight')
