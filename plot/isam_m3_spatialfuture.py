...
region=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/mai_irr_fert/output/mai_irr_fert.nc','r')
ma1 = region.variables['totalyield'][75:85,:,:]#2090-2099
#ma1 = region.variables['yield'][99,:,:]

region1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/soy_irr_fert/output/soy_irr_fert.nc','r')
ma2 = region1.variables['totalyield'][75:85,:,:]
...
meareaisam = isam1.variables['fmai_tt'][75:85,:,:]#2090-2099
meareaisam= ma.masked_where(meareaisam<=0.0,meareaisam)
ma1=ma1*meareaisam

isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_rcp45_corrcrop.nc','r')
meareaisam1 = isam1.variables['fsoy_tt'][75:85,:,:]#2090-2099
...
cs1 = map.pcolormesh(x,y,ma1/gridarea*10000,cmap=cmap,norm=norm)
...
map.drawmapboundary()
#ncvar_y=maskoceans(x1,y1,ncvar_y)
cs1 = map.pcolormesh(x,y,ma2/gridarea*10000,cmap=cmap,norm=norm)
#cs1 = map.pcolormesh(x,y,ma2,cmap=plt.cm.gist_earth,vmin=0,vmax=5)
plt.axis('off')
cbar = map.colorbar(cs1,location='bottom',size="5%",pad="2%",ticks=bounds,extend='max')
cbar.ax.tick_params(labelsize=16)

plt.savefig('isam_m3_maisoybase45.jpg',bbox_inches='tight')
