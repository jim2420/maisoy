...
region1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/new/soy_irr_fert/output/soy_irr_fert.nc','r')
...
ma1c=N.ma.average(ma1c,axis=0)
ma2c=N.ma.average(ma2c,axis=0)
ma1f=N.ma.average(ma1f,axis=0)
ma2f=N.ma.average(ma2f,axis=0)
ma1cli=N.ma.average(ma1cli,axis=0)
ma2cli=N.ma.average(ma2cli,axis=0)
...
plt.savefig('isamdiffbase_maisoyglobalnew.jpg',bbox_inches='tight')
