...
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/equili/maiequilibrium_irr/output/maiequilibrium_irr.nc','r')
ma1i = dat2.variables['totalyield'][95:105,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_fert/output/maiequilibrium_fert.nc','r')
ma1f = dat3.variables['totalyield'][95:105,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_co2/output/maiequilibrium_co2.nc','r')
ma1c = dat4.variables['totalyield'][95:105,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_cli/output/maiequilibrium_cli.nc','r')
ma1cli = dat5.variables['totalyield'][95:105,:,:]

dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
ma2i = dat2.variables['totalyield'][95:105,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_fert/output/soyequilibrium_fert.nc','r')
ma2f = dat3.variables['totalyield'][95:105,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_co2/output/soyequilibrium_co2.nc','r')
ma2c = dat4.variables['totalyield'][95:105,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_cli/output/soyequilibrium_cli.nc','r')
...
cmap = plt.cm.bwr
#bounds=[-15,-12,-9,-6,-3,0,20,40,60,80,100]
bounds=[-0.5,-0.4,-0.3,-0.2,-0.1,0,1,2,3,4,5]
norm = colors.BoundaryNorm(bounds, cmap.N)

bounds1=[-0.5,-0.4,-0.3,-0.2,-0.1,0,0.2,0.4,0.6,0.8,1]
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,-bb,cmap=cmap,norm=norm1)
#cs1 = map.pcolormesh(x,y,ma2,cmap=plt.cm.gist_earth,vmin=0,vmax=5)
plt.axis('off')
cbar = map.colorbar(cs1,location='right',size="5%",pad="2%",ticks=bounds1,extend='both')
cbar.ax.tick_params(labelsize=16)
...
plt.savefig('isamdiffbase_maisoyglobalyieldequ.jpg',bbox_inches='tight')
