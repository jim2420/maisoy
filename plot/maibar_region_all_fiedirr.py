...
g=0
N.savetxt('maihis0.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')
g=1
N.savetxt('maihis1.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')
g=2
N.savetxt('maihis2.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')
g=3
N.savetxt('maihis3.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')
g=4
N.savetxt('maihis4.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')
g=7
N.savetxt('maihis7.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')
g=8
N.savetxt('maihis8.csv', (eco[g],co[g],ecli[g],cli[g],eii[g],ii[g],enn[g],nn[g]), delimiter=',')

plt.savefig('mai_region_id_fixedirr.png')
plt.show()
