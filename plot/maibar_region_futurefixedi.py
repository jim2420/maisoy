...
edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/equili/maiequilibrium_irr/output/maiequilibrium_irr.nc','r')
...
edat285=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/equili/maiequilibrium_irr/output/maiequilibrium_irr.nc','r')
...
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/mai_irr/output/mai_irr.nc','r')
iyield3ynew = dat3.variables['totalyield'][75:85,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/mai_co2/output/mai_co2.nc','r')
iyield4ynew = dat4.variables['totalyield'][75:85,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/mai_cli/output/mai_cli.nc','r')
...
dat385=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/mai_irr/output/mai_irr.nc','r')
iyield3ynew85 = dat385.variables['totalyield'][75:85,:,:]

dat485=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/mai_co2/output/mai_co2.nc','r')
iyield4ynew85 = dat485.variables['totalyield'][75:85,:,:]

dat585=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/mai_cli/output/mai_cli.nc','r')
...
plt.savefig('mai_region_idfuturefixedirr1.png')
plt.show()
