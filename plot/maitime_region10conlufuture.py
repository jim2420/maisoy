...
#	plt.ylim(-75, 75)
	...
	if i==0 or i==2 or i==4 or i==6 or i==8: 
		...
		print ['e{0}p'.format(xy)]
                plt.bar(0.01+index+bar_width*1,locals()['e{0}p451'.format(xy)][0,15:20],bar_width,alpha=opacity,color='black')
                #plt.bar(0.01+index+bar_width*1,locals()['e{0}p851'.format(xy)][0,5:20],"k-",label="Global",linewidth=2)

                plt.bar(0.01+index+bar_width*2,locals()['e{0}p451'.format(xy)][1,15:20],bar_width,alpha=opacity,color='r')
                plt.bar(0.01+index+bar_width*3,locals()['e{0}p451'.format(xy)][2,15:20],bar_width,alpha=opacity,color='y')
                plt.bar(0.01+index+bar_width*4,locals()['e{0}p451'.format(xy)][3,15:20],bar_width,alpha=opacity,color='m')
                plt.bar(0.01+index+bar_width*5,locals()['e{0}p451'.format(xy)][4,15:20],bar_width,alpha=opacity,color='c')
                plt.bar(0.01+index+bar_width*6,locals()['e{0}p451'.format(xy)][7,15:20],bar_width,alpha=opacity,color='b')
                plt.bar(0.01+index+bar_width*7,locals()['e{0}p451'.format(xy)][8,15:20],bar_width,alpha=opacity,color='g')
...
#                ax.set_yticklabels([])
		...
		xy=gge[gc]
                print ['{0}p'.format(xy)]
                plt.bar(0.01+index+bar_width*1,locals()['{0}p451'.format(xy)][0,15:20],bar_width,alpha=opacity,color='k')
                #plt.bar(0.01+index+bar_width*1,locals()['{0}p851'.format(xy)][0,5:20],"k-",label="Global",linewidth=2)


                plt.bar(0.01+index+bar_width*2,locals()['{0}p451'.format(xy)][1,15:20],bar_width,alpha=opacity,color='r')
                plt.bar(0.01+index+bar_width*3,locals()['{0}p451'.format(xy)][2,15:20],bar_width,alpha=opacity,color='y')
                plt.bar(0.01+index+bar_width*4,locals()['{0}p451'.format(xy)][3,15:20],bar_width,alpha=opacity,color='m')
                plt.bar(0.01+index+bar_width*5,locals()['{0}p451'.format(xy)][4,15:20],bar_width,alpha=opacity,color='c')
                plt.bar(0.01+index+bar_width*6,locals()['{0}p451'.format(xy)][7,15:20],bar_width,alpha=opacity,color='b')
                plt.bar(0.01+index+bar_width*7,locals()['{0}p451'.format(xy)][8,15:20],bar_width,alpha=opacity,color='g')
...
#		plt.xlabel("Year",fontsize=12)
                plt.xticks(index + bar_width+0.4, ('2050s','2060s','2070s','2080s','2090s'))
...
plt.savefig('maize_regiontime10barluf45.png',dpi=300,bbox_inches='tight')
plt.show()
