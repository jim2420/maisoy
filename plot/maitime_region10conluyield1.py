...
#		
	...
	print ['e{0}p'.format(xy)]
        plt.bar(0.01+index+bar_width*1,locals()['e{0}p851'.format(xy)][0,19],bar_width,alpha=opacity,color='b')
                #plt.bar(0.01+index+bar_width*1,locals()['e{0}p851'.format(xy)][0,5:20],"k-",label="Global",linewidth=2)

        plt.bar(0.04+index+bar_width*3,locals()['e{0}p851'.format(xy)][1,19],bar_width,alpha=opacity,color='b')
        plt.bar(0.07+index+bar_width*5,locals()['e{0}p851'.format(xy)][2,19],bar_width,alpha=opacity,color='b')
        plt.bar(0.10+index+bar_width*7,locals()['e{0}p851'.format(xy)][3,19],bar_width,alpha=opacity,color='b')
        plt.bar(0.13+index+bar_width*9,locals()['e{0}p851'.format(xy)][4,19],bar_width,alpha=opacity,color='b')
        plt.bar(0.16+index+bar_width*11,locals()['e{0}p851'.format(xy)][7,19],bar_width,alpha=opacity,color='b')
        plt.bar(0.19+index+bar_width*13,locals()['e{0}p851'.format(xy)][8,19],bar_width,alpha=opacity,color='b')
	...
	xy=gge[gc]
        print ['{0}p'.format(xy)]
        plt.bar(0.01+index+bar_width*2,locals()['{0}p851'.format(xy)][0,19],bar_width,alpha=opacity,color='r')
        plt.bar(0.04+index+bar_width*4,locals()['{0}p851'.format(xy)][1,19],bar_width,alpha=opacity,color='r')
        plt.bar(0.07+index+bar_width*6,locals()['{0}p851'.format(xy)][2,19],bar_width,alpha=opacity,color='r')
        plt.bar(0.10+index+bar_width*8,locals()['{0}p851'.format(xy)][3,19],bar_width,alpha=opacity,color='r')
        plt.bar(0.13+index+bar_width*10,locals()['{0}p851'.format(xy)][4,19],bar_width,alpha=opacity,color='r')
        plt.bar(0.16+index+bar_width*12,locals()['{0}p851'.format(xy)][7,19],bar_width,alpha=opacity,color='r')
        plt.bar(0.19+index+bar_width*14,locals()['{0}p851'.format(xy)][8,19],bar_width,alpha=opacity,color='r')
...
plt.savefig('mai_regiontime10barluyield1rcp85.png',dpi=300,bbox_inches='tight')
plt.show()
