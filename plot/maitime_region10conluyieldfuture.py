...
dat1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/mairegion_rcp85new.nc','r')
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/mairegion_rcp45new.nc','r')
...
g=0
N.savetxt('maircp45.csv', (ecop451[g,19],cop451[g,19],eclp451[g,19],clp451[g,19],eip451[g,19],ip451[g,19],efp451[g,19],fp451[g,19]), delimiter=',')
N.savetxt('maircp85.csv', (ecop851[g,19],cop851[g,19],eclp851[g,19],clp851[g,19],eip851[g,19],ip851[g,19],efp851[g,19],fp851[g,19]), delimiter=',')
...
plt.savefig('mai_region2090srcp45new.png',dpi=300,bbox_inches='tight')
plt.show()
