...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/mai1901_2015regionco2.nc','r')
...
N.savetxt('maipro2000syield.csv', (ecop851[0,9],eclp851[0,9],eip851[0,9],efp851[0,9],cop851[0,9],clp851[0,9],ip851[0,9],fp851[0,9]), delimiter=',')
...
#plt.savefig('soy_regiontime10barluyield.png',dpi=300,bbox_inches='tight')
plt.show()
