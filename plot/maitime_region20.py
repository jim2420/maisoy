...
#	plt.ylim(-75, 75)
	...
	if i==0 or i==2 or i==4 or i==6: 
		...
		print ['e{0}p'.format(xy)]
                ...
                ax.plot(gx,locals()['e{0}p451'.format(xy)][0,2:10],"k--",label="Global",linewidth=2)
                ax.plot(gx,locals()['e{0}p851'.format(xy)][0,2:10],"k-",label="Global",linewidth=2)

                ax.plot(gx,locals()['e{0}p451'.format(xy)][1,2:10],"r--",label="NA",linewidth=1)
                ax.plot(gx,locals()['e{0}p451'.format(xy)][2,2:10],"y--",label="SA",linewidth=1)
                ax.plot(gx,locals()['e{0}p451'.format(xy)][3,2:10],"m--",label="EU",linewidth=1)
                ax.plot(gx,locals()['e{0}p451'.format(xy)][4,2:10],"c--",label="Africa",linewidth=1)
                ax.plot(gx,locals()['e{0}p451'.format(xy)][7,2:10],"b--",label="China",linewidth=1)
                ax.plot(gx,locals()['e{0}p451'.format(xy)][8,2:10],"g--",label="SSEA",linewidth=1)


		ax.plot(gx,locals()['e{0}p851'.format(xy)][1,2:10],"r-",label="NA",linewidth=1)
		ax.plot(gx,locals()['e{0}p851'.format(xy)][2,2:10],"y-",label="SA",linewidth=1)

		ax.plot(gx,locals()['e{0}p851'.format(xy)][3,2:10],"m-",label="EU",linewidth=1)
		ax.plot(gx,locals()['e{0}p851'.format(xy)][4,2:10],"c-",label="Africa",linewidth=1)

		ax.plot(gx,locals()['e{0}p851'.format(xy)][7,2:10],"b-",label="China",linewidth=1)
		ax.plot(gx,locals()['e{0}p851'.format(xy)][8,2:10],"g-",label="SSEA",linewidth=1)
		g=g+1
		...
		xy=gge[gc]
                print ['{0}p'.format(xy)]
                ax.plot(gx,locals()['{0}p451'.format(xy)][0,2:10],"k--",label="Global",linewidth=2)
                ax.plot(gx,locals()['{0}p851'.format(xy)][0,2:10],"k-",label="Global",linewidth=2)

                ax.plot(gx,locals()['{0}p451'.format(xy)][1,2:10],"r--",label="NA",linewidth=1)
                ax.plot(gx,locals()['{0}p451'.format(xy)][2,2:10],"y--",label="SA",linewidth=1)
                ax.plot(gx,locals()['{0}p451'.format(xy)][3,2:10],"m--",label="EU",linewidth=1)
                ax.plot(gx,locals()['{0}p451'.format(xy)][4,2:10],"c--",label="Africa",linewidth=1)
                ax.plot(gx,locals()['{0}p451'.format(xy)][7,2:10],"b--",label="China",linewidth=1)
                ax.plot(gx,locals()['{0}p451'.format(xy)][8,2:10],"g--",label="SSEA",linewidth=1)


                ax.plot(gx,locals()['{0}p851'.format(xy)][1,2:10],"r-",label="NA",linewidth=1)
                ax.plot(gx,locals()['{0}p851'.format(xy)][2,2:10],"y-",label="SA",linewidth=1)
                ax.plot(gx,locals()['{0}p851'.format(xy)][3,2:10],"m-",label="EU",linewidth=1)
                ax.plot(gx,locals()['{0}p851'.format(xy)][4,2:10],"c-",label="Africa",linewidth=1)
                ax.plot(gx,locals()['{0}p851'.format(xy)][7,2:10],"b-",label="China",linewidth=1)
                ax.plot(gx,locals()['{0}p851'.format(xy)][8,2:10],"g-",label="SSEA",linewidth=1)
                gc=gc+1
...
plt.savefig('maize_regiontime20.png',dpi=300,bbox_inches='tight')
plt.show()
