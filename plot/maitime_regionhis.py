...
#	plt.ylim(-75, 75)
	...
	if i==0 or i==2 or i==4 or i==6: 
		...
		print ['e{0}p'.format(xy)]
                ax.plot(gx,locals()['e{0}p45'.format(xy)][0,59:115],"k--",label="Global",linewidth=2)
                ax.plot(gx,locals()['e{0}p85'.format(xy)][0,59:115],"k-",label="Global",linewidth=2)
                ax.plot(gx,locals()['e{0}p45'.format(xy)][1,59:115],"r--",label="NA",linewidth=1)
                ax.plot(gx,locals()['e{0}p45'.format(xy)][2,59:115],"y--",label="SA",linewidth=1)
                ax.plot(gx,locals()['e{0}p45'.format(xy)][3,59:115],"m--",label="EU",linewidth=1)
                ax.plot(gx,locals()['e{0}p45'.format(xy)][4,59:115],"c--",label="Africa",linewidth=1)
                ax.plot(gx,locals()['e{0}p45'.format(xy)][7,59:115],"b--",label="China",linewidth=1)
                ax.plot(gx,locals()['e{0}p45'.format(xy)][8,59:115],"g--",label="SSEA",linewidth=1)

#                ax.plot(gx,locals()['e{0}p85'.format(xy)][0,59:200],"k-",label="Global",linewidth=2)
		ax.plot(gx,locals()['e{0}p85'.format(xy)][1,59:115],"r-",label="NA",linewidth=1)
		ax.plot(gx,locals()['e{0}p85'.format(xy)][2,59:115],"y-",label="SA",linewidth=1)

		ax.plot(gx,locals()['e{0}p85'.format(xy)][3,59:115],"m-",label="EU",linewidth=1)
		ax.plot(gx,locals()['e{0}p85'.format(xy)][4,59:115],"c-",label="Africa",linewidth=1)

		ax.plot(gx,locals()['e{0}p85'.format(xy)][7,59:115],"b-",label="China",linewidth=1)
		ax.plot(gx,locals()['e{0}p85'.format(xy)][8,59:115],"g-",label="SSEA",linewidth=1)
		g=g+1
		...
		xy=gge[gc]
                print ['{0}p'.format(xy)]
                ax.plot(gx,locals()['{0}p45'.format(xy)][0,59:115],"k--",label="Global",linewidth=2)
                ax.plot(gx,locals()['{0}p85'.format(xy)][0,59:115],"k-",label="Global",linewidth=2)

                ax.plot(gx,locals()['{0}p45'.format(xy)][1,59:115],"r--",label="NA",linewidth=1)
                ax.plot(gx,locals()['{0}p45'.format(xy)][2,59:115],"y--",label="SA",linewidth=1)
                ax.plot(gx,locals()['{0}p45'.format(xy)][3,59:115],"m--",label="EU",linewidth=1)
                ax.plot(gx,locals()['{0}p45'.format(xy)][4,59:115],"c--",label="Africa",linewidth=1)
                ax.plot(gx,locals()['{0}p45'.format(xy)][7,59:115],"b--",label="China",linewidth=1)
                ax.plot(gx,locals()['{0}p45'.format(xy)][8,59:115],"g--",label="SSEA",linewidth=1)

#                ax.plot(gx,locals()['{0}p85'.format(xy)][0,59:200],"k-",label="Global",linewidth=2)
                ax.plot(gx,locals()['{0}p85'.format(xy)][1,59:115],"r-",label="NA",linewidth=1)
                ax.plot(gx,locals()['{0}p85'.format(xy)][2,59:115],"y-",label="SA",linewidth=1)
                ax.plot(gx,locals()['{0}p85'.format(xy)][3,59:115],"m-",label="EU",linewidth=1)
                ax.plot(gx,locals()['{0}p85'.format(xy)][4,59:115],"c-",label="Africa",linewidth=1)
                ax.plot(gx,locals()['{0}p85'.format(xy)][7,59:115],"b-",label="China",linewidth=1)
                ax.plot(gx,locals()['{0}p85'.format(xy)][8,59:115],"g-",label="SSEA",linewidth=1)
                gc=gc+1
...
plt.savefig('maize_regiontimehis.png',dpi=300,bbox_inches='tight')
plt.show()
