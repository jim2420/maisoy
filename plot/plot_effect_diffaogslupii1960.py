...
meareaisam = isam1.variables['fmai_tt'][1110:1160,:,:]#1960-2009
meareaisam= ma.masked_where(meareaisam<=0.0,meareaisam)
print meareaisam.shape
fmearea = isam1.variables['fmai_tt'][1051,:,:]#1901
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_irr_fert/output/mai_irr_fert.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/mai_fert/output/mai_fert.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_cli/output/mai_cli.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_irr/output/mai_irr.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/mai_co2/output/mai_co2.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium/output/maiequilibrium.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_fert/output/maiequilibrium_fert.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/equili/maiequilibrium_irr/output/maiequilibrium_irr.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_co2/output/maiequilibrium_co2.nc','r')
...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/maiequilibrium_cli/output/maiequilibrium_cli.nc','r')
...
tsbase1=(N.average(base[0:10]),N.average(base[10:20]),N.average(base[20:30]),N.average(base[30:40]),N.average(base[40:50]))
...
bar_width = 0.11
opacity = 0.6
print tayc,taycli,tayirr,tayf,tsbase,tsbase1
...
plt.savefig('maip_effect_aogsluii1960.png')
plt.show()
