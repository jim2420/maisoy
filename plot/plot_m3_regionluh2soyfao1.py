...
isam1=NetCDFFile('../code/isamhiscru_soy_luh2new.nc','r')
...
N.savetxt('soymeaurefao.csv', (afy1,afy2,afy3,afy4,afy5,afy8,afy9), delimiter=',')
N.savetxt('soymeaurem3.csv', (allym3[0],allym3[1],allym3[2],allym3[3],allym3[4],allym3[7],allym3[8]), delimiter=',')
N.savetxt('soymeaurespam.csv', (spamyy[0],spamyy[1],spamyy[2],spamyy[3],spamyy[4],spamyy[7],spamyy[8]), delimiter=',')
N.savetxt('soymeaureilly.csv', (iially[0,:],iially[1,:],iially[2,:],iially[3,:],iially[4,:],iially[7,:],iially[8,:]), delimiter=',')
...
N.savetxt('soymeaure.csv', (allyisam1,allyisam1_std,faoy1,faoy1_std), delimiter=',')
...
plt.tight_layout()
plt.savefig('soy_regionyfnew.png')
plt.show()
...
plt.tight_layout()
plt.savefig('soy_regionpfnew.png')
plt.show()
...
plt.tight_layout()
plt.savefig('soy_regiony1new.png')
plt.show()
