...
plt.tight_layout()
plt.savefig('soy_regionyf1.png')
plt.show()

fig = plt.figure(figsize=(10,10))
colors = N.random.rand(7)
aarea=aarea/(10**4) #ha
plt.scatter(faoy1, allyisam1, s=aarea, c=colors, alpha=0.5)
plt.xlabel("Measured yield (t/ha)",fontsize=50)
plt.ylabel("ISAM yield (t/ha)",fontsize=50)
plt.errorbar(faoy1, allyisam1, yerr=faoy1_std, linestyle='none', ecolor='black')
...
plt.tick_params(axis='both',labelsize=50)
plt.tight_layout()
plt.savefig('soy_scatteryf1.png')
plt.show()
...
plt.tight_layout()
plt.savefig('soy_regiony1f1.png')
plt.show()
