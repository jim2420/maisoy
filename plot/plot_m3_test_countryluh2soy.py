...
faop=[16780,1537,5275800,640,0,577,28111,1017634,108500,953,312432,149300,5403,0]
faoy=[0.8492,1.2160,0.8222,0.9275,'nan',0.6411,0.8453,1.2335,0.9507,1.2313,1.4531,1.2031,0.8442,0]
faoa=[19759,1264,6416600,690,0,900,33256,825000,114121,774,215014,124100,6400,0]
num=14
...
plt.tight_layout()
plt.savefig('m32000soyyield.png')
plt.show()
