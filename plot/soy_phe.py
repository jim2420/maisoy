...
nclu=NetCDFFile('soy_growing_season_dates.nc4','r')
#print(nclu)
...
for i, year in enumerate(years):
    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/vmax2/soy_irr_fert/output/soy_irr_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
ncvar_plt= ma.masked_where(maskus[:,:]==0,ncvar_plt)
ncvar_har= ma.masked_where(maskus[:,:]==0,ncvar_har)
ncvar_len= ma.masked_where(maskus[:,:]==0,ncvar_len)
...
plt.savefig('soyphe_avg_irrvmax2.jpg',dpi=300,bbox_inches='tight')
plt.show()
