...
edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
eiyield2ynew = edat2.variables['totalyield'][95:105,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_irr/output/soy_irr.nc','r')
eiyield3ynew = edat3.variables['totalyield'][95:105,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_co2/output/soy_co2.nc','r')
eiyield4ynew = edat4.variables['totalyield'][95:105,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_cli/output/soy_cli.nc','r')
...
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_irr/output/soy_irr.nc','r')
iyield3ynew = dat3.variables['totalyield'][95:105,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_co2/output/soy_co2.nc','r')
iyield4ynew = dat4.variables['totalyield'][95:105,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_cli/output/soy_cli.nc','r')
...
for idx in xrange(9):
	...
	opacity = 0.6
        ...
        arects2 = plt.bar(index+0.05, eii[idx], bar_width, yerr=esii[idx],
        ...
        drects3 = plt.bar(index+0.05+bar_width*3, cli[idx], bar_width, yerr=scli[idx],
                 alpha=opacity,color='blue',
                 label='Climate')
	erects0 = plt.bar(index+0.05+bar_width*4, eco[idx], bar_width,yerr=esco[idx],hatch='..',
	         alpha=opacity,color='black',
	         label='CO$_{2}$')
        frects0 = plt.bar(index+0.05+bar_width*5, co[idx], bar_width,yerr=sco[idx],
                 alpha=opacity,color='black',
                 label='CO$_{2}$')
...
plt.savefig('soy_region_amounitt.png')
plt.show()
