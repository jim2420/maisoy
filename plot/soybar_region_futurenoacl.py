...
edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
...
edat285=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
...
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/soy_irr/output/soy_irr.nc','r')
iyield3ynew = dat3.variables['totalyield'][75:85,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/soy_co2/output/soy_co2.nc','r')
iyield4ynew = dat4.variables['totalyield'][75:85,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/soy_cli/output/soy_cli.nc','r')
...
dat385=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_irr/output/soy_irr.nc','r')
iyield3ynew85 = dat385.variables['totalyield'][75:85,:,:]

dat485=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_co2/output/soy_co2.nc','r')
iyield4ynew85 = dat485.variables['totalyield'][75:85,:,:]

dat585=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_cli/output/soy_cli.nc','r')
...
plt.savefig('soy_region_idfuture_noacli.png')
plt.show()
