...
region1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_soy_luh2rcp45.nc','r')
...
region2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/code/isamhiscru_soy_luh2rcp85.nc','r')
...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/equili/soyequilibrium/output/soyequilibrium.nc','r')
eiyield1ynew = edat.variables['totalyield'][75:85,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
eiyield2ynew = edat2.variables['totalyield'][75:85,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/equili/soyequilibrium_fert/output/soyequilibrium_fert.nc','r')
eiyield3ynew = edat3.variables['totalyield'][75:85,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/equili/soyequilibrium_co2/output/soyequilibrium_co2.nc','r')
eiyield4ynew = edat4.variables['totalyield'][75:85,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/equili/soyequilibrium_cli/output/soyequilibrium_cli.nc','r')
eiyield5ynew = edat5.variables['totalyield'][75:85,:,:]
 
edat85=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium/output/soyequilibrium.nc','r')
eiyield1ynew85 = edat85.variables['totalyield'][75:85,:,:]

edat285=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/equili/soyequilibrium_irr/output/soyequilibrium_irr.nc','r')
eiyield2ynew85 = edat285.variables['totalyield'][75:85,:,:]

edat385=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_fert/output/soyequilibrium_fert.nc','r')
eiyield3ynew85 = edat385.variables['totalyield'][75:85,:,:]

edat485=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_co2/output/soyequilibrium_co2.nc','r')
eiyield4ynew85 = edat485.variables['totalyield'][75:85,:,:]

edat585=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/equili/soyequilibrium_cli/output/soyequilibrium_cli.nc','r')
eiyield5ynew85 = edat585.variables['totalyield'][75:85,:,:]

dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/soy_irr_fert/output/soy_irr_fert.nc','r')
iyield1ynew = dat.variables['totalyield'][75:85,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/noaclimate/soy_fert/output/soy_fert.nc','r')
iyield2ynew = dat2.variables['totalyield'][75:85,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/soy_irr/output/soy_irr.nc','r')
iyield3ynew = dat3.variables['totalyield'][75:85,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/soy_co2/output/soy_co2.nc','r')
iyield4ynew = dat4.variables['totalyield'][75:85,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp45/fixedirr/soy_cli/output/soy_cli.nc','r')
iyield5ynew = dat5.variables['totalyield'][75:85,:,:]


dat85=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_irr_fert/output/soy_irr_fert.nc','r')
iyield1ynew85 = dat85.variables['totalyield'][75:85,:,:]

dat285=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/noaclimate/soy_fert/output/soy_fert.nc','r')
iyield2ynew85 = dat285.variables['totalyield'][75:85,:,:]

dat385=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/soy_irr/output/soy_irr.nc','r')
iyield3ynew85 = dat385.variables['totalyield'][75:85,:,:]

dat485=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/soy_co2/output/soy_co2.nc','r')
iyield4ynew85 = dat485.variables['totalyield'][75:85,:,:]

dat585=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/rcp85/fixedirr/soy_cli/output/soy_cli.nc','r')
...
#                ax.set_yticklabels([-30,-15,0,15,30,45,60])
#        else:
#                ax.set_yticklabels([])
...
#	plt.axis('off')
	...
	ax.text(.55,.85,'{0}'.format(name[idx]),fontsize=12,
...
plt.savefig('soy_region_idfuture_noaclifixedirr1.png')
plt.show()
