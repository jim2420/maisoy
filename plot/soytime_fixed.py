...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_irr_fert/output/soy_irr_fert.nc','r')
iyield1ynew = dat.variables['totalyield'][0:115,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_co2_irr/output/soy_co2_irr.nc','r')
...
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_co2_fert/output/soy_co2_fert.nc','r')
iyield3ynew = dat3.variables['totalyield'][0:115,:,:]

dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_irr/output/soy_irr.nc','r')
...
dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_co2_cli/output/soy_co2_cli.nc','r')
iyield5ynew = dat5.variables['totalyield'][0:115,:,:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/fixedirr/soy_cli/output/soy_cli.nc','r')
...
#print av1[6]-av4[6],bav2[6]-av2[6],bav3[6]-av3[6],bav5[6]-av5[6]
...
plt.savefig('soy_yearfixed.png',dpi=300,bbox_inches='tight')
plt.show()
