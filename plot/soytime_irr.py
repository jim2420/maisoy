...
edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/equili/soyequilibrium_irr/output/soyequilibrium_irr_irr.nc','r')
...
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_irr/output/soy_irr_irr.nc','r')
iyield3ynew = dat3.variables['irrigation'][0:115,1,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_co2/output/soy_co2_irr.nc','r')
iyield4ynew = dat4.variables['irrigation'][0:115,1,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/maisoy_cheyenne/his_cru/soy_cli/output/soy_cli_irr.nc','r')
...
N.savetxt('soyirr.csv', (av1,av4,av5,av3,eav2), delimiter=',')
...
plt.savefig('soy_yearirr.png',dpi=300,bbox_inches='tight')
plt.show()
