...
#	plt.ylim(-75, 75)
	...
	if i==0 or i==2 or i==4 or i==6: 
		...
		print ['e{0}p'.format(xy)]
                plt.bar(0.01+index+bar_width*1,locals()['e{0}p451'.format(xy)][0,5:10],bar_width,alpha=opacity,color='black',label='Global')
                #plt.bar(0.01+index+bar_width*1,locals()['e{0}p851'.format(xy)][0,5:20],"k-",label="Global",linewidth=2)

                plt.bar(0.01+index+bar_width*2,locals()['e{0}p451'.format(xy)][1,5:10],bar_width,alpha=opacity,color='r',label='NA')
                plt.bar(0.01+index+bar_width*3,locals()['e{0}p451'.format(xy)][2,5:10],bar_width,alpha=opacity,color='y',label='SA')
                plt.bar(0.01+index+bar_width*4,locals()['e{0}p451'.format(xy)][3,5:10],bar_width,alpha=opacity,color='m',label='EU')
                plt.bar(0.01+index+bar_width*5,locals()['e{0}p451'.format(xy)][4,5:10],bar_width,alpha=opacity,color='c',label='Africa')
                plt.bar(0.01+index+bar_width*6,locals()['e{0}p451'.format(xy)][7,5:10],bar_width,alpha=opacity,color='b',label='China')
                plt.bar(0.01+index+bar_width*7,locals()['e{0}p451'.format(xy)][8,5:10],bar_width,alpha=opacity,color='g',label='SSEA')
...
leg = plt.legend(loc=2,ncol=7, fontsize=16)
...
plt.savefig('soybean_regiontime10bartest.png',dpi=300,bbox_inches='tight')
plt.show()
